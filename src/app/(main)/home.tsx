    ...
    <div className='min-h-screen flex flex-col items-center py-8 md:justify-center lg:justify-center gap-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-6 gap-6 max-w-6xl px-4'>
        <div
          ...
          className='bg-zinc-900 shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-zinc-800 cursor-pointer hover:border-zinc-600 md:col-span-2'
        >
        ...
        <div className='bg-zinc-900 shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-zinc-800 cursor-pointer hover:border-zinc-600 md:col-span-2'>
        ...
        <div className='bg-zinc-900 shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-zinc-800 cursor-pointer hover:border-zinc-600 md:col-span-3'>
          <h2 className='text-xl font-bold text-zinc-100 mb-3'>
